...
sap.ui.define([
	...
	return BaseController.extend("ZHTS.ZHTS.controller.ScoringRecords", {
		...
		onInit: function () {
			...
			const route = router.getRoute("scoring_records");
		...
		onPatternMatched: function (event) {
			...
			var ZMPGCODE = oModel.getData().ZMPGCODE;
			...
			if(ZMPGCODE !== "") {
				filters.push(new Filter("ZMPGCODE", FilterOperator.EQ, ZMPGCODE));
			}
