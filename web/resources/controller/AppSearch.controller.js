...
sap.ui.define([
	...
	return BaseController.extend("ZHTS.ZHTS.controller.AppSearch", {
		...
		onInit: function () {
			...
			const route = router.getRoute("app_search");
		...
		onSearch: function(oEvent) {
			...
			var MPGCODE = this.byId("MPGCODE").getValue().trim();
